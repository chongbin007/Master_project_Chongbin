...
`scp /Users/chongbin/Desktop/chongbin_master_project/experiments/experiment2/code_ros1/rosberry_experiments/src/test_latency_main.py ubuntu@192.168.1.11:/home/ubuntu/catkin_ws/src/rosberry_experiments/src`
1. 把文件从远程主机copy到当前系统
`scp ubuntu@192.168.1.11:/home/ubuntu/catkin_ws/src/rosberry_experiments/src/times_10.csv /Users/chongbin/Desktop/chongbin_master_project/experiments/experiment2/ros1_result` 
 
**copy 文件加 -r** 

1. 本地到远程
`scp -r /Users/chongbin/Desktop/chongbin_master_project/experiments/experiment2/code_ros1/rosberry_experiments ubuntu@192.168.1.12:/home/ubuntu/catkin_ws/src`
1. 远程到本地
...
`scp -r /Users/chongbin/Desktop/chongbin_master_project/experiments/code_ros2/minimal_publisher comros2@192.168.1.2:/home/comros2/ros2_example_ws/src`
...
`. ~/ros2_example_ws/install/setup.bash`
运行代码
`ros2 run examples_rclpy_minimal_publisher udp_server`
在当前目录得到结果文件拷贝出来做数据处理
`scp comros1@192.168.1.1:/home/comros1/ros2_example_ws/ros2_latency.csv /Users/chongbin/Desktop/chongbin_master_project/experiments/experiment2/ros2_result`
...
## 待完成
8.5 实验2延迟 对比，报告 
8.5 - 8.10 实验3 吞吐量实验，报告 
8.10 写报告
未来实验，可以包括多线程，多节点的测试，吞吐量和延迟测试